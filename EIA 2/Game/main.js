    ...
    window.addEventListener("load", function () {
        ...
        function drawGame() {
            ...
            for (var i = snake.length - 1; i >= 0; i--) {
                //checken ob Schlangenkopf irgendwo anst��t,d.h. border vom canvas 
                if (i === 0) {
                    switch (direction) {
                        case 0:
                    ...
                    //wenn Schlange sich bewegt soll der K�rper immer dorthin, wo quadrat davor war.  
                    if (i === (snake.length - 1)) {
        ...
        function Food(cnvs) {
            ...
            //Futter und Schlangenk�rper d�rfen nicht an gleicher Stelle sein
        ...
        function gameOver() {
            ...
            crc2.fillText('GAME OVER', ((canvas.width / 4) - (crc2.measureText('GAME OVER').width / 4)), 50);
        }
    });
})(game || (game = {}));
;
