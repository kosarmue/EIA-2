...
(function (auf11) {
    ...
    auf11.baumArt = []; //Assoziatives Array (In jeder Schublade 2 F�cher)
    auf11.b = [];
    for (var i = 0; i < auf11.posten.length; i++) {
        if (auf11.posten[i].art == "Baumform") {
            var temp = [auf11.posten[i].name, auf11.posten[i].preis]; //erstellt ein assoziatives array 
            auf11.baumArt.push(temp); //Variable temp wird an n�chste Stelle des Arrays gepusht
        }
    }
})(auf11 || (auf11 = {}));
